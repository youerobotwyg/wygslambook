...
void pose_estimation_2d2d(
    std::vector<KeyPoint> keypoins_1,
    std::vector<KeyPoint> keypoint_2,
    std::vector<DMatch> matches,
    Mat& R, Mat& t);
...
int main(int argc, char** argv)
{
    ...
    Mat t_x = (Mat_<double>(3,3)<<
                ...
                t.at<double>(2,0), 0, -t.at<double>(1,0),
                -t.at<double>(1,0), t.at<double>(2,0), 0);
    ...
    for(DMatch m:matches)
    {
        ...
        Point2d pt2 = pixel2cam(keypoint_2[m.queryIdx].pt,K);
                          ...
                          Mat& R, Mat& t)
{
    ...
    for(int i=0; i<(int)matches.size(); i++)
    {
        ...
        points2.push_back(keypoint_2[matches[i].queryIdx].pt);
    }
